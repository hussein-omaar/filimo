...
function Hero() {
    ...
    const [movie , setMovie] = useState([
...

        {
            ...
            "Poster2" : "https://i.pinimg.com/originals/05/e9/1a/05e91ad8f14bef57810399e14da2600f.jpg",
            "Poster": "https://www.wallpaperflare.com/static/65/1010/479/breaking-bad-selective-coloring-walter-white-jesse-pinkman-wallpaper.jpg"
        },
  ...
  return (
    ...
    <section style={{ backgroundImage: `url(${movie[0].Poster})` }}  className='hero_section'>
                ...
                <div className='nav-links'>
                   <nav>
                    <ul>
                        ...
                        <li><button>Movie & series</button></li>
            ...
            <div className='movie-info'>
                <div className='movie-details'>
                    ...
                    <div className='poster-details'>
                       ...
                       <p> A high school chemistry teacher diagnosed with inoperable lung cancer
