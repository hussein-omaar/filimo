        ...
        <div className='public-comments'>
          ...
          <div className='com'>
            <div className='com-info'>
              ...
              <div className='review'>
                <small>bruhperson</small>
                <p>The best series i have seen in my whole life even better than the wire </p>
              </div>
            </div>
            <div className='date'>
              <span  className='out-of'>10/10</span>
          ...
          <div className='com'>
            <div className='com-info'>
              ...
              <div className='review'>
                <small>bruhperson</small>
                <p>i wanna delete my brain the watch it againg like i never knew it  </p>
              </div>
            </div>
            <div className='date'>
            <span  className='out-of'>10/10</span>
          ...
          <div className='com'>
            <div className='com-info'>
              ...
              <div className='review'>
                <small>bruhperson</small>
                <p>The most perfect show ever created. There will no other show like this  </p>
              </div>
            </div>
            <div className='date'>
            <span>10/10</span>
